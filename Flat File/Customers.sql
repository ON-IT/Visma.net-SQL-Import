/*
	This is from the Visma.net import template imported to SQL for cleaning.

	If you are using the import template from Visma.net, remember to rename columns
	with spaces and punctuations to remove them.
*/
SELECT
	[name] = Cust.Kundenavn, 	   
